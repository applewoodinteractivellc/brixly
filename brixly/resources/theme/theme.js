...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__brixly_kube_component__ = __webpack_require__(100);
/* harmony reexport (default from non-hamory) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_1__brixly_kube_component__["a"]; });



__WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a.registerPlugin = function (name, plugin, autoload) {
  ...
  __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a[name] = plugin;
  // Brixly[name].inherits(Brixly);
  __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a.Plugin.create(name);

  if (autoload !== false) {
    __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a.Plugin.autoload(name);
  }
};
...
(function (name, definition) {
  ...
  if (typeof jQuery === 'undefined') {
    throw new Error('Brixly requires jQuery');
  }

  ;(function ($) {
    var version = $.fn.jquery.split('.');
    if (version[0] === 1 && version[1] < 8) {
      throw new Error('Brixly requires at least jQuery v1.8');
    }
  })(jQuery);

  var _Brixly;

  var lib_prefix = "brixly.";
  ...
  ;(function () {
    ...
    // Core Class
    _Brixly = function Brixly(element, options) {
      options = (typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object' ? options : {};

      this.$element = $(element);
      var instanceId = this.$element.data('brixly-id');

      var instanceData = _Brixly.getData(instanceId);
    ...
    _Brixly.getData = function (id) {
      if (window.brixlyData && window.brixlyData[id]) {
        return window.brixlyData[id];
      }

      return {};
    };

    _Brixly.isCustomizerPreview = function () {
      return !!window.brixlyCustomizerPreviewData;
    };
    // Core Functionality
    _Brixly.prototype = {
      updateOpts: function updateOpts(updatedData) {
        var instanceId = this.instance;
        var instanceData = $.extend(true, {}, this.defaults, _Brixly.getData(instanceId));
  ...
  (function (Brixly) {
    Brixly.Plugin = {
        ...
        $.fn[pluginname] = function (method, options) {
          ...
          this.each(function () {
            ...
            if (!data) {
              // Initialization
              $this.data(name, {});
              data = new Brixly[classname](this, options);
              $this.data(name, data);
            }
      ...
      startAutoloadOnce: function startAutoloadOnce() {
        var self = this;
        var $nodes = $('[data-brixly-component]').not('[data-loaded]').not('[data-disabled]');
        $nodes.each(function () {
          var $el = $(this);
          var pluginname = lib_prefix + $el.data('brixly-component');
      ...
      watch: function watch() {
        Brixly.Plugin.startAutoloadOnce();
        Brixly.Plugin.startAutoload();
      }
    };
  ...
  (function (Brixly) {
    Brixly.Animation = function (element, effect, callback) {
      this.namespace = 'animation';
      this.defaults = {};

      // Parent Constructor
      Brixly.apply(this, arguments);
    ...
    Brixly.Animation.prototype = {
      ...
      animate: function animate() {
        ...
        this.$element.addClass('brixly-animated');
      ...
      clean: function clean() {
        this.$element.removeClass('brixly-animated').removeClass(this.queue[0]);
      }
    };

    // Inheritance
    Brixly.Animation.inherits(Brixly);
  })(_Brixly);
  ...
  (function ($) {
    ...
    $.fn[animationName] = function (effect, callback) {
      ...
      return this.each(function () {
        ...
        $this.data(name, {});
        $this.data(name, data = new _Brixly.Animation(this, effect, callback));
      });
    };

    $.fn[animationName].options = {};

    _Brixly.animate = function ($target, effect, callback) {
  ...
  (function (Brixly) {
    Brixly.Detect = function () {};

    Brixly.Detect.prototype = {
  ...
  (function (Brixly) {
    Brixly.Utils = function () {};

    Brixly.Utils.prototype = {
...
var BaseHandler = function () {
  ...
  _createClass(BaseHandler, [{
    ...
    value: function setVideo(node) {
      node.className = 'brixly-video-background-item';
...
(function ($, Brixly) {
  ...
  var Component = function Component(element, options) {
    ...
    // Services
    this.utils = new Brixly.Utils();
    this.detect = new Brixly.Detect();
  ...
  Component.prototype = {
    start: function start() {
      ...
      this.$target.trigger('brixly.offcanvas.ready');
    ...
    addOffcanvasOverlayLogic: function addOffcanvasOverlayLogic() {
      ...
      if ($offCanvasWrapper.length) {
        ...
        $offCanvasWrapper.on('brixly.offcanvas.open', function () {
          $overlayElement.addClass('h-offcanvas-opened');
        });

        $offCanvasWrapper.on('brixly.offcanvas.close', function () {
    ...
    open: function open(e) {
      ...
      if (!this.isOpened()) {
        ...
        this.$target.trigger('brixly.offcanvas.open');
        // this.$target.animation(this.opts.animationOpen, $.proxy(this.onOpened, this));
        Brixly.animate(this.$target, this.opts.animationOpen, $.proxy(this.onOpened, this));
        this.$element.trigger('brixly.offcanvas.open');
      }
    },
    ...
    close: function close(e) {
      ...
      if (this.isOpened()) {
        ...
        this.callback('close');
        this.pullBody();
        this.$target.trigger('brixly.offcanvas.close');
        // this.$target.animation(this.opts.animationClose, $.proxy(this.onClosed, this));
        Brixly.animate(this.$target, this.opts.animationClose, $.proxy(this.onClosed, this));
      }
    },
    ...
    onClosed: function onClosed() {
      ...
      this.$target.trigger('brixly.offcanvas.closed');
    },
  ...
  Component.inherits(Brixly);
  Brixly[className] = Component;

  Brixly.Plugin.create(className);
  Brixly.Plugin.autoload(className);
})(jQuery, Brixly);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__root_static_free_masonryBrixly__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__root_static_free_masonryBrixly___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__root_static_free_masonryBrixly__);
...
__WEBPACK_IMPORTED_MODULE_3__page_components_common_scripts_base___["b" /* BrixlyFrontend */].registerPlugin(__WEBPACK_IMPORTED_MODULE_4__kube_slideshow_customizable_slideshow__["a" /* default */]);
__WEBPACK_IMPORTED_MODULE_3__page_components_common_scripts_base___["b" /* BrixlyFrontend */].registerPlugin(__WEBPACK_IMPORTED_MODULE_5__kube_video_background_customizable_video_background__["a" /* default */]);

__WEBPACK_IMPORTED_MODULE_3__page_components_common_scripts_base___["b" /* BrixlyFrontend */].getData = function (id) {
    if (window.brixlyFrontendData && window.brixlyFrontendData[id]) {
        return window.brixlyFrontendData[id];
    }

    return {};
};

window.Brixly = __WEBPACK_IMPORTED_MODULE_3__page_components_common_scripts_base___["b" /* BrixlyFrontend */];
...
var BrixlyFrontComponent = function () {
  _createClass(BrixlyFrontComponent, null, [{
    key: 'componentName',
  ...
  function BrixlyFrontComponent(element, options) {
    _classCallCheck(this, BrixlyFrontComponent);

    this.$ = jQuery;
    this.namespace = this.constructor.componentName();
    this.utils = new __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a.Utils();
    this.detect = new __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a.Detect();
    this.init();
    __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a.apply(this, arguments);
    this.start();
  ...
  _createClass(BrixlyFrontComponent, [{
    key: 'init',
    value: function init() {}
  }, {
    key: 'isCustomizerPreview',
    value: function isCustomizerPreview() {
      return __WEBPACK_IMPORTED_MODULE_0__root_static_free_brixly___default.a.isCustomizerPreview();
    }
  }, {
    key: 'wpCustomize',
  ...
  return BrixlyFrontComponent;
}();

/* harmony default export */ __webpack_exports__["a"] = (BrixlyFrontComponent);
...
var Slideshow = function (_ColibriFrontComponen) {
  ...
  return Slideshow;
}(__WEBPACK_IMPORTED_MODULE_0__page_components_common_scripts_base_index__["a" /* BrixlyFrontComponent */]);
...
var CustomizableVideoBackground = function (_VideoBackground) {
    ...
    _createClass(CustomizableVideoBackground, [{
        ...
        value: function wpCustomize(api) {
            ...
            this.API_URL = brixly_ADDITIONAL_JS_DATA.api_url;
...
(function ($) {
  function inCustomizer() {
    return Brixly.isCustomizerPreview();
  }
...
(function ($, Brixly) {
  ...
  var Component = function Component(element, options) {
    ...
    this.defaults = {
      menuSelector: '.brixly-menu',
      offCanvasWrapper: '.brixly-menu-container',
      ...
      if ($.fn.scrollSpy) {
        $menu.find('a').scrollSpy({
          ...
          offset: function offset() {
            var $fixed = $menu.closest('[data-brixly-component="navigation"]');
            if ($fixed.length) {
...
(function ($, Brixly) {
  ...
  Component.prototype = {
    ...
    scriptCallIsValid: function scriptCallIsValid() {
      var isInCustomizer = Brixly.isCustomizerPreview();
      if (!isInCustomizer) {
        return true;
      }
    ...
    startOverlap: function startOverlap() {
      var self = this;
      var $target = this.$element.closest('[data-brixly-navigation-overlap]');

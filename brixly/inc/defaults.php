...
$brixly_theme_divider_style = array(
...
$brixly_theme_edit_this_text_in_customizer = __( 'You can edit this text in customizer', 'brixly' );
$brixly_theme_action_button                = __( 'Action Button %d', 'brixly' );
...
return array(
	...
	'assets_js_key'                     => "brixlyFrontendData",
	'edit_this_text_in_customizer'      => $brixly_theme_edit_this_text_in_customizer,
	'default_icon'                      => $brixly_theme_svg_icons['fort-awesome'],
	'icons'                             => $brixly_theme_svg_icons,
	'divider_style'                     => $brixly_theme_divider_style,
	"gradients"                         => array(
		'night_fade'  =>
			array(
				'name'  => 'night_fade',
	...
	'header_front_page'                 => array(
						...
						array(
							0 =>
								array(
									'source' =>
										array(
											'url' => get_template_directory_uri() . '/resources/images/images-xheader-default-0-1545411152082.jpg',
										)
								)
						),
					"slideshow" => array(
		...
		"title"        => array(
			"show"  => true,
			"value" => $brixly_theme_edit_this_text_in_customizer,
		),
		"subtitle"     => array(
			"show"  => true,
			"value" => $brixly_theme_edit_this_text_in_customizer,
		...
		"social_icons" => array(
			...
			"localProps" => array(
				"icons" => json_encode( array(
					array(
						'icon'       => $brixly_theme_svg_icons['facebook'],
						'link_value' => 'http://www.facebook.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $brixly_theme_svg_icons['twitter'],
						'link_value' => 'http://www.facebook.com/',
						'index'      => 1,
					),
					array(
						'icon'       => $brixly_theme_svg_icons['youtube'],
						'link_value' => 'http://www.youtube.com/',
						'index'      => 2,
					),
					array(
						'icon'       => $brixly_theme_svg_icons['vimeo'],
		...
		"icon_list"    => array(
			...
			"localProps" => array(
				"iconList" => json_encode( array(
					array(
						'icon'       => $brixly_theme_svg_icons['map-marker'],
						'text'       => 'Location, State, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $brixly_theme_svg_icons['phone-square'],
						'text'       => '(000) 123 12345',
						'link_value' => 'https://www.twitter.com/',
						'index'      => 1,
					),
					array(
						'icon'       => $brixly_theme_svg_icons['envelope'],
		...
		"button_group" => array(
			...
			"value" => json_encode( array(
				array(
					'label'       => sprintf( $brixly_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $brixly_theme_action_button, 2 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
	...
	'front_page_designs' => array(
		...
		array(
			'name'  => __( "Modern", 'brixly' ),
			"index" => 2,
		),

		array(
			'name'  => __( "Classic", 'brixly' ),
			"index" => 1,
		),

		array(
			'name'  => __( "Fullscreen", 'brixly' ),
			"index" => 3,
		),
	)
);

...
class PluginsManager {
	...
	public function boot() {
		$data               = Hooks::brixly_apply_filters( 'theme_plugins', array() );
		$this->tgmpa_config = Hooks::brixly_apply_filters( 'tgmpa_config', array(
			'id'           => get_template(),
			'default_path' => '',
		...
		add_action( 'wp_ajax_brixly_activate_plugin', function () {

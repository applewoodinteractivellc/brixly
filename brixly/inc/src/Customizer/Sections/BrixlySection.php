...
namespace BrixlyWP\Theme\Customizer\Sections;


use BrixlyWP\Theme\Translations;

class BrixlySection extends \WP_Customize_Section {
	public $type = 'brixly_section';
	...
	protected function render_template() {
        ...
        <li id="accordion-section-{{ data.id }}"
            ...
            <ul class="accordion-section-content">
                ...
                <li class="brixly-section-tabs-section customize-control">

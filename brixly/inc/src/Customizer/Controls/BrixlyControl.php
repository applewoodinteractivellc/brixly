...
class BrixlyControl extends \WP_Customize_Control
{

    const DEFAULT_BRIXLY_TAB = 'content';
    const STYLE_BRIXLY_TAB = 'style';

    protected $brixly_tab = self::DEFAULT_BRIXLY_TAB;
    protected $default     = '';
    ...
    public function __construct(WP_Customize_Manager $manager, $id, array $args = array())
    {
        ...
        $exclude_keys = array_merge(
            ...
            array(
                "transport",
                "brixly_selective_refresh_key",
                "brixly_selective_refresh_class",
                "css_output",
            )
        );

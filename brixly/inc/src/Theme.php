...
use BrixlyWP\Theme\Core\ComponentInterface;
...
class Theme {
	...
	public function afterSetup() {
		...
		add_action( 'wp_ajax_brixly_disable_big_notice', function () {
		...
		Hooks::brixly_do_action( 'theme_loaded', $this );
	...
	public function addThemeNotice() {
		...
		if ( $show_big_notice && ! $is_builder_installed ) {
			...
			?>
            <div class="notice notice-success is-dismissible brixly-admin-big-notice notice-large">
	...
	public function addThemeInfoPage() {
		$tabs = Hooks::brixly_apply_filters( 'info_page_tabs', array() );
		...
		$page_name = Hooks::brixly_apply_filters( 'theme_page_name', Translations::get( 'theme_page_name' ) );
		add_theme_page(
			$page_name,
			$page_name,
			'activate_plugins',
	...
	public function printThemePage() {
		...
		View::make( "admin/page",
			array(
				...
				'page_url'        => $url,
				'welcome_message' => Hooks::brixly_apply_filters( 'info_page_welcome_message', $welcome_message ),
				'welcome_info'    => Hooks::brixly_apply_filters( 'info_page_welcome_info', $welcome_info ),
			)
		);
	...
	/**
	 * @return \BrixlyWP\Theme\ComponentsRepository
	 */
	...
	/**
	 * @param \BrixlyWP\Theme\ComponentsRepository $repository
	 */

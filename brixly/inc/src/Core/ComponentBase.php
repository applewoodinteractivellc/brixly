					...
					if ( $has_control ) {
						...
						if ( array_key_exists( 'selective_refresh', $options['settings'][ $id ]['control'] ) ) {
							...
							if ( array_key_exists( 'selector', $selective_refresh ) ) {
								$options['settings'][ $id ]['control']['brixly_selective_refresh_selector']
									= $selective_refresh['selector'];
							}

							if ( array_key_exists( 'function', $selective_refresh ) ) {
								$options['settings'][ $id ]['control']['brixly_selective_refresh_function']
						...
						$options['settings'][ $id ]['control']['brixly_selective_refresh_class']       = $__class__;

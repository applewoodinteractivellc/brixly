...
class MainContent extends ComponentBase {
		...
		return array(
			"settings" => array(
				...
				"blog_post_thumb_placeholder_color" => array(
					...
					'css_output' => array(
						array(
							'selector' => '.brixly-post-has-no-thumbnail.brixly-post-thumbnail-has-placeholder .brixly-post-thumbnail-content',
	...
	public function renderContent() {
		...
		}, array( array( 'blog-page', 'brixly-main-content-area' ) ) );
	}

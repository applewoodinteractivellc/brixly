...
namespace BrixlyWP\Theme\Components\Header;


use BrixlyWP\Theme\Components\CSSOutput;
...
class HeaderMenu extends ComponentBase {
	...
	protected static function getContentOptions() {
		$prefix   = static::$settings_prefix;
		$selector = '[data-brixly-component="dropdown-menu"]';
...
//						'solid-active-item'                                         => Translations::escHtml( "background" ),
	...
	public function printHeaderMenu() {
		...
		wp_nav_menu( array(
			...
			'fallback_cb'     => array( $this, "brixlyNomenuFallback" ),
		) );
	...
	function brixlyMenuAddShopingCart() {
		add_filter( 'wp_nav_menu_items', array( $this, 'brixly_woocommerce_cart_menu_item' ), 10, 2 );
		add_filter( 'brixly_nomenu_after', array( $this, 'brixly_woocommerce_cart_menu_item' ), 10, 2 );
	}

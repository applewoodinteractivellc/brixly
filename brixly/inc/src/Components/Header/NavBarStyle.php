...
use BrixlyWP\Theme\Core\PartialComponent;
			...
			"settings" => array(
				...
				"{$prefix}props.layoutType" => array(
					...
					'css_output' => array(
						...
						array(
							'selector' => "{$this->selector} div > .brixly-menu-container > ul.brixly-menu",
					...
					/*'js_output' => array(
						array(
							...
							'action'   => 'brixly-component-restart',
							'value'    => 'navigation'
						),
					)*/
				),
				...
				"{$prefix}props.sticky" => array(
					...
					'js_output' => array(
						array(
							'selector' => "{$this->selector}#navigation",
							'action'   => "brixly-navigation-toggle-sticky",
						),
...
//						array(
//							'selector' => "{$this->selector}#navigation",
//							'action'   => "brixly-navigation-toggle-overlap",
//							'callback' => "brixlyUpdateHeroPenPosition",
//						),
//					),
//				),
				...
				"{$prefix}props.width" => array(
					...
					'js_output' => array(
						array(
							...
							'action'   => "set-class",
							'value'    => array(
								'boxed'      => 'brixly-theme-nav-boxed',
								'full-width' => 'brixly-theme-nav-full-width'
							),
						),
						array(
				...
				"{$prefix}style.padding.top.value" => array(
					...
					'css_output' => array(
						array(
							"selector"      => $this->selector . "[data-brixly-component=\"navigation\"]#navigation",
		...
		switch ( $layoutType ) {
			case 'logo-above-menu':
				$css .= "{$this->selector} .h-column-container  { flex-basis: 100%; }" .
				        ...
				        "{$this->selector} div > .brixly-menu-container > ul.brixly-menu { justify-content: center; }";
				break;
		}

<div class="h-column h-column-container d-flex h-col-lg-12 h-col-md-12 h-col-12  masonry-item style-114-outer style-local-25-m5-outer">
  <div data-brixly-id="25-m5" class="d-flex h-flex-basis h-column__inner h-px-lg-0 h-px-md-0 h-px-0 v-inner-lg-0 v-inner-md-0 v-inner-0 style-114 style-local-25-m5 position-relative">
    <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
      <div data-brixly-id="25-m6" class="h-blog-categories empty-preview style-115 style-local-25-m6 position-relative h-element">
      ...
      <div data-brixly-id="25-m7" class="h-blog-title style-116 style-local-25-m7 position-relative">
        <div class="h-global-transition-all">
      ...
      <div data-brixly-id="25-m8" class="h-blog-meta h-global-transition-all style-117 style-local-25-m8 position-relative">
      ...
      <?php endif; ?>
      <div data-brixly-id="25-m9" class="style-118 style-local-25-m9 position-relative">
        <div class="h-global-transition-all">
      ...
      <div data-brixly-id="25-m10" class="h-x-container style-119 style-local-25-m10 position-relative h-element">
        <div class="h-x-container-inner style-dynamic-25-m10-group">
          <span class="h-button__outer style-120-outer style-local-25-m11-outer d-inline-flex h-element">
            <a href="<?php the_permalink(); ?>" data-brixly-id="25-m11" class="d-flex w-100 align-items-center h-button style-120 style-local-25-m11 position-relative">
              <span>

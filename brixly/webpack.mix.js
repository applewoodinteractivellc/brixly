...
let themeHead = "/*\n" +
    " Theme Name:   Brixly WP\n" +
    " Version:      @@build@@\n" +
    " Theme URI:    https://brixly.com/go/brixly-theme/\n" +
    " Description:  Brixly Theme is a very flexible, multipurpose WordPress theme that takes the Customizer to the next level.\n" +
    " Author:       Extendthemes\n" +
    " Author URI:   https://brixly.com/\n" +
